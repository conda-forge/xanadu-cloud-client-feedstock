...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xanadu-cloud-client-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14735&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xanadu-cloud-client-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xanadu-cloud-client` can be installed with:

```
conda install xanadu-cloud-client
```

It is possible to list all of the versions of `xanadu-cloud-client` available on your platform with:
